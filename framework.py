...
class Example(Frame):
    ...
    def initUI(self):
        ...
        #Display of symbols
        display = Label(self, text="My name is Aparna")
        display.grid(row=5, column=0, rowspan=2, columnspan=3, sticky=E+W)
        #Display done
        ...
        b1 = Button(buttongrid, text="b1")
        b1.grid(row=1, column=3)

        b2 = Button(buttongrid, text="b2")
        b2.grid(row=1, column=4)

        b3 = Button(buttongrid, text="b3")
        b3.grid(row=1, column=5)

        b4 = Button(buttongrid, text="b4")
        b4.grid(row=1, column=6)

        b5 = Button(buttongrid, text="b5")
        b5.grid(row=2, column=3)

        b6 = Button(buttongrid, text="b6")
        b6.grid(row=2, column=4)

        b7 = Button(buttongrid, text="b7")
        b7.grid(row=2, column=5)

        b8 = Button(buttongrid, text="b8")
        b8.grid(row=2, column=6)

        b9 = Button(buttongrid, text="b9")
        b9.grid(row=3, column=3)

        b10 = Button(buttongrid, text="b10")
        b10.grid(row=3, column=4)

        b11 = Button(buttongrid, text="b11")
        b11.grid(row=3, column=5)

        b12 = Button(buttongrid, text="b12")
